...
function Products () {
    ...
    useEffect(()=>{                             //methode 1 difference que la methode 1 affiche l'erreur en cas d'erreur par contre la methode 2 n'affiche que le resultat
      getProducts()
      .then((res)=>{
    ...
    /* const getAllProducts = async()=>{}       //methode 2
